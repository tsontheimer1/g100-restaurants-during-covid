...
# -*- coding: utf-8 -*-
"""
Created on Sun May  9 16:23:26 2021
...
#%%
#Lastly, let's make a mosaic graph across each of the top 10 states.

#sm.graphics.mosaicplot.mosaic(full_state_sum, index=None, ax=None, horizontal=True, gap=0.005, axes_label=True, label_rotation=0.0)

#mo_state = sns.load_dataset('full_state_sum')
#mosaic(mo_state, ['NAICSCode','ProjectState','CurrentApprovalAmount'])
#plt.show()
